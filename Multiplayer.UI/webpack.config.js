...
// Built next to the sources; the C# project copies Multiplayer.mjs (and .css) into the mod folder on build,
// so the toolchain deploy step never wipes the UI bundle.
